...
<%--        <input type="hidden" name="size" value="${pageRequestDTO.size}">--%>
    ...
    <br>
    <div>
        <input class="form-check-input" type="checkbox" name="types" value="t">
        <label class="form-check-label">
            제목
        </label>
        <input class="form-check-input" type="checkbox" name="types" value="w">
        <label class="form-check-label">
            작성자
        </label>
    </div>
...
<section style="padding: 15px">
    ...
    <table class="table" style="margin: 15px">
        ...
        <tr>
            ...
            <td><a href="/view?tno=${dto.tno}&${pageRequestDTO.link}" class="text-decoration-none" data-tno="${dto.tno}"><c:out value="${dto.title}"/></a></td>
